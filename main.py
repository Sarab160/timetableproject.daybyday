...
ctk.CTkLabel(app, text="Break Period Number (e.g., 3):").pack(pady=5)
break_period_input = ctk.CTkEntry(app, placeholder_text="3", width=200)
...
export_pdf_btn = ctk.CTkButton(
    app,
    text="Export as PDF",
    command=lambda: export_pdf(timetable, selected_classes,break_period)
)
export_pdf_btn.pack(pady=10)
reset_display_btn = ctk.CTkButton(app, text="Clear Timetable Display", command=clear_timetable_display)
